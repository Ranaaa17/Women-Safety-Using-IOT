"""the_role_of_iot_in_womans_safety URL Configuration
...
from the_role_of_iot_in_womans_safety import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Woman_Safety_Status/$', remoteuser.Predict_Woman_Safety_Status, name="Predict_Woman_Safety_Status"),
    ...
    url(r'^View_Prediction_Of_Woman_Safety_Status_Ratio/$', serviceprovider.View_Prediction_Of_Woman_Safety_Status_Ratio, name="View_Prediction_Of_Woman_Safety_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Woman_Safety_Status/$', serviceprovider.View_Prediction_Of_Woman_Safety_Status, name="View_Prediction_Of_Woman_Safety_Status"),
