...
ROOT_URLCONF = 'the_role_of_iot_in_womans_safety.urls'
...
WSGI_APPLICATION = 'the_role_of_iot_in_womans_safety.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'the_role_of_iot_in_womans_safety',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
